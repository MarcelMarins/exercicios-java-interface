...
public class EX6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(153, 255, 204), null, null));

        jLabel1.setFont(new java.awt.Font("Showcard Gothic", 0, 18)); // NOI18N
        jLabel1.setText("Eu tenho um número entre 1 e 100, você consegue adivinhá-lo?");
        ...
        jToggleButton1.setLabel("Tentar");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        chute = Integer.parseInt(jTextField2.getText());
        
        if (chute < ale){
            
            jTextField1.setText(String.valueOf("O numero é maior que " + chute));
            
            
        }else if (chute > ale){
            
            
             jTextField1.setText(String.valueOf("O numero é menor que " + chute));
        
        }else if (chute == ale){
            
            
            JOptionPane.showMessageDialog(null, "Parbens!! Você acertou!!!");
